<?php
// Test file untuk memverifikasi login page
session_start();
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="login-container">
        ...
        <div class="login-form-side">
            ...
            <div class="alert alert-info border-0 shadow-sm mb-4">
                <strong>✓ Halaman Login Berhasil Dimuat!</strong><br>
                Ini adalah halaman test. Akses <code>index.php</code> untuk login sebenarnya.
            </div>
